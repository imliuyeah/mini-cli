...
// runTransformation 函数接收三个参数，第一个参数是一个对象，包含了文件的路径和内容，
// 第二个参数是一个函数，表示要执行的转换函数，第三个参数是一个对象，包含了转换函数需要的参数
        ...
        Object.keys(files).forEach(file => {
            ...
            if (injections && injections.length > 0) {
                files[file] = runTransformation(
                    ...
                    require('./utils/codemods/injectPlugins'),
                    { injections },
                )
            }
        })
