...
async function create(name) {
    ...
    // 获取各个模块的交互提示语 格式：[{name: 'babel', prompt: 'Use Babel'}, ...]
    ...
    // // 这段代码中的 packageManager 是用户选择的包管理工具
    // if (answers.packageManager) {
    //     // saveOptions 的作用是将用户选择的包管理工具保存到 .vuerc 文件中
    //     saveOptions({
    ...
    // 填入 vue 和 vite
    answers.features.unshift('vue', 'vite', 'api')
